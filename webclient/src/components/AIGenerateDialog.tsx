...
export function AIGenerateDialog({ open, onClose, onGenerate, onViewAutomation }: AIGenerateDialogProps) {
      ...
      <div className="aig-dialog" onClick={(e) => e.stopPropagation()}>
        ...
        {phase === 'input' && (
          <>
            ...
            <h3 id="aig-title" className="aig-title">Generate Automation</h3>
        ...
        {phase === 'loading' && (
          <>
            ...
            <h3 className="aig-title">Generating Automation</h3>
        ...
        {phase === 'success' && result && (
          <>
            ...
            <h3 className="aig-title">Automation Created</h3>
            ...
            <div className="aig-actions">
              ...
              <button
                type="button"
                className="aig-btn primary"
                onClick={() => onViewAutomation(result.id)}
              >
                View Automation
              </button>
            </div>
