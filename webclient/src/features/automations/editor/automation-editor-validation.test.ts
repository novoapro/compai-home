...
import type { AutomationDraft } from './automation-editor-types';
import { emptyDraft } from './automation-editor-types';

describe('validateDraft', () => {
  it('returns empty array for valid complete automation', () => {
  ...
  it('validates automation trigger (which has no specific requirements)', () => {
    const draft = emptyDraft();
    draft.name = 'Automation Trigger';
    draft.triggers = [
      {
        _draftId: 'trigger-1',
        type: 'automation',
