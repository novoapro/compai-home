...
enum ConcurrentExecutionPolicy: String, Codable, CaseIterable, Identifiable {
    /// Ignore the new trigger while the automation is already running.
    case ignoreNew
    ...
    var displayName: String {
        ...
        case .cancelAndRestart: return "Restart automation"
        case .queueAndExecute: return "Queue new execution"
        case .cancelOnly: return "Cancel automation"
        }
    }

    var description: String {
        switch self {
        case .ignoreNew: return "New triggers are ignored while the automation is running."
...
struct Automation: Identifiable, Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        let decodedTriggers = try container.decode([AutomationTrigger].self, forKey: .triggers)
        conditions = try container.decodeIfPresent([AutomationCondition].self, forKey: .conditions)
        ...
        // Backward compat: migrate automation-level retriggerPolicy to triggers that don't have one
        let automationPolicy = retriggerPolicy
        triggers = decodedTriggers.map { trigger in
            if trigger.retriggerPolicy == nil {
                return trigger.withRetriggerPolicy(automationPolicy)
            }
            return trigger
        }
    }
...
struct AutomationMetadata: Codable {
    ...
    static let empty = AutomationMetadata(
        createdBy: nil,
        tags: nil,
        lastTriggeredAt: nil,
        totalExecutions: 0,
...
// MARK: - AutomationBlock (Action vs. Flow Control)

indirect enum AutomationBlock: Codable {
    case action(AutomationAction, blockId: UUID)
    ...
    init(from decoder: Decoder) throws {
        ...
        switch kind {
        case .action:
            self = try .action(AutomationAction(from: decoder), blockId: blockId)
        case .flowControl:
...
enum FlowControlBlock: Codable {
    ...
    case stop(StopBlock)
    case executeAutomation(ExecuteAutomationBlock)
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case targetAutomationId, executionMode
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        case .waitForState:
            ...
            if let deviceId = try container.decodeIfPresent(String.self, forKey: .deviceId) {
                // Legacy flat format — convert to AutomationCondition.deviceState
                let charId = try container.decode(String.self, forKey: .characteristicId)
                ...
                condition = try container.decode(AutomationCondition.self, forKey: .condition)
            }
        ...
        case .conditional:
            self = try .conditional(ConditionalBlock(
                condition: container.decode(AutomationCondition.self, forKey: .condition),
                thenBlocks: container.decode([AutomationBlock].self, forKey: .thenBlocks),
                elseBlocks: container.decodeIfPresent([AutomationBlock].self, forKey: .elseBlocks),
                name: name
            ))
        case .repeat:
            self = try .repeat(RepeatBlock(
                count: container.decode(Int.self, forKey: .count),
                blocks: container.decode([AutomationBlock].self, forKey: .blocks),
        ...
        case .executeAutomation:
            self = try .executeAutomation(ExecuteAutomationBlock(
                targetAutomationId: container.decode(UUID.self, forKey: .targetAutomationId),
    ...
    func encode(to encoder: Encoder) throws {
        ...
        case let .executeAutomation(block):
            try container.encode(FlowControlType.executeAutomation, forKey: .type)
            try container.encodeIfPresent(block.name, forKey: .name)
            try container.encode(block.targetAutomationId, forKey: .targetAutomationId)
    ...
    var displayType: String {
        ...
        case .executeAutomation: return "executeAutomation"
        }
    }
}
...
struct WaitForStateBlock {
    ...
    init(condition: AutomationCondition, timeoutSeconds: Double, name: String? = nil) {
...
struct ConditionalBlock {
    let condition: AutomationCondition
    let thenBlocks: [AutomationBlock]
    let elseBlocks: [AutomationBlock]?
    let name: String?

    init(condition: AutomationCondition, thenBlocks: [AutomationBlock], elseBlocks: [AutomationBlock]? = nil, name: String? = nil) {
        self.condition = condition
...
struct RepeatBlock {
    ...
    init(count: Int, blocks: [AutomationBlock], delayBetweenSeconds: Double? = nil, name: String? = nil) {
        self.count = count
        self.blocks = blocks
...
struct RepeatWhileBlock {
    ...
    init(condition: AutomationCondition, blocks: [AutomationBlock], maxIterations: Int = 100, delayBetweenSeconds: Double? = nil, name: String? = nil) {
        self.condition = condition
        self.blocks = blocks
...
struct GroupBlock {
    ...
    init(label: String? = nil, blocks: [AutomationBlock], name: String? = nil) {
        self.label = label
        self.blocks = blocks
        self.name = name
    }
...
enum ExecutionMode: String, Codable, CaseIterable, Identifiable {
    ...
    var description: String {
        switch self {
        case .inline: return "Wait for the target automation to finish before continuing"
        case .parallel: return "Launch the target automation and continue immediately"
        case .delegate: return "Launch the target automation and stop this one"
        }
    }
}

struct ExecuteAutomationBlock: Codable {
    let targetAutomationId: UUID
    let executionMode: ExecutionMode
    let name: String?

    init(targetAutomationId: UUID, executionMode: ExecutionMode = .inline, name: String? = nil) {
        self.targetAutomationId = targetAutomationId
...
enum AutomationTrigger: Codable {
    ...
    case automation(AutomationCallTrigger)
    ...
    init(from decoder: Decoder) throws {
        ...
        let triggerConditions = try container.decodeIfPresent([AutomationCondition].self, forKey: .conditions)
        switch type {
        case .deviceStateChange:
            let charId = try container.decode(String.self, forKey: .characteristicId)
        ...
        case .automation:
            self = .automation(AutomationCallTrigger(name: name, retriggerPolicy: policy, conditions: triggerConditions))
        case .sunEvent:
    ...
    func encode(to encoder: Encoder) throws {
        ...
        case let .webhook(trigger):
            ...
            try container.encodeIfPresent(trigger.retriggerPolicy, forKey: .retriggerPolicy)
            try container.encodeIfPresent(trigger.conditions, forKey: .conditions)
        case let .automation(trigger):
            try container.encode(TriggerType.automation, forKey: .type)
            try container.encodeIfPresent(trigger.name, forKey: .name)
            try container.encodeIfPresent(trigger.retriggerPolicy, forKey: .retriggerPolicy)
            try container.encodeIfPresent(trigger.conditions, forKey: .conditions)
    ...
    var retriggerPolicy: ConcurrentExecutionPolicy? {
        ...
        case .automation(let t): return t.retriggerPolicy
    ...
    var conditions: [AutomationCondition]? {
        ...
        case .automation(let t): return t.conditions
        case .sunEvent(let t): return t.conditions
        }
    }

    /// Returns a copy of this trigger with the given retrigger policy applied.
    func withRetriggerPolicy(_ policy: ConcurrentExecutionPolicy) -> AutomationTrigger {
        switch self {
...
struct ScheduleTrigger {
    ...
    init(scheduleType: ScheduleType, name: String? = nil, retriggerPolicy: ConcurrentExecutionPolicy? = nil, conditions: [AutomationCondition]? = nil) {
...
struct WebhookTrigger {
    ...
    init(token: String = UUID().uuidString, name: String? = nil, retriggerPolicy: ConcurrentExecutionPolicy? = nil, conditions: [AutomationCondition]? = nil) {
        self.token = token
        self.name = name
        self.retriggerPolicy = retriggerPolicy
        self.conditions = conditions
...
struct AutomationCallTrigger: Codable {
    let name: String?
    let retriggerPolicy: ConcurrentExecutionPolicy?
    let conditions: [AutomationCondition]?

    init(name: String? = nil, retriggerPolicy: ConcurrentExecutionPolicy? = nil, conditions: [AutomationCondition]? = nil) {
        self.name = name
        self.retriggerPolicy = retriggerPolicy
        self.conditions = conditions
    }
...
struct SunEventTrigger {
    ...
    init(event: SunEventType, offsetMinutes: Int = 0, name: String? = nil, retriggerPolicy: ConcurrentExecutionPolicy? = nil, conditions: [AutomationCondition]? = nil) {
        self.event = event
...
// MARK: - Automation Conditions (Guard Expressions)

indirect enum AutomationCondition: Codable {
    ...
    init(from decoder: Decoder) throws {
        ...
        case .or:
            self = try .or(container.decode([AutomationCondition].self, forKey: .conditions))
        case .not:
            self = try .not(container.decode(AutomationCondition.self, forKey: .condition))
        }
    }
...
/// Legacy — kept only for backward-compatible decoding of existing automations.
...
protocol TriggerEvaluator {
    func canEvaluate(_ trigger: AutomationTrigger) -> Bool
    func evaluate(_ trigger: AutomationTrigger, context: TriggerContext) async -> Bool
}
...
struct AutomationExecutionLog: Identifiable, Codable {
    let id: UUID
    ...
    /// The full `AutomationExecutionLog` is embedded in the payload so clients receive the complete
    /// block execution tree without a second request.
    func toStateChangeLog() -> StateChangeLog {
        let category: LogCategory = (status == .failure) ? .automationError : .automationExecution
        return StateChangeLog(
            id: id,
            timestamp: triggeredAt,
            category: category,
            payload: category == .automationError ? .automationError(self) : .automationExecution(self)
        )
    }
}
...
/// was submitted, not the outcome of the automation execution itself.
enum TriggerResult: Codable {
    case scheduled(automationId: UUID, automationName: String)
    case replaced(automationId: UUID, automationName: String)
    case queued(automationId: UUID, automationName: String)
    case ignored(automationId: UUID, automationName: String)
    case cancelled(automationId: UUID, automationName: String)
    case guardNotMet(automationId: UUID, automationName: String)
    case notFound
    case disabled
    case automationDisabled(automationId: UUID, automationName: String)

    var message: String {
        switch self {
        case .scheduled(_, let name):
            return "Automation '\(name)' execution scheduled."
        case .replaced(_, let name):
            return "Previous execution of '\(name)' was cancelled; new execution scheduled."
        case .queued(_, let name):
            return "Automation '\(name)' has been queued for execution."
        ...
        case .automationDisabled(_, let name):
    ...
    var isAccepted: Bool {
        ...
        case .ignored, .notFound, .disabled, .automationDisabled, .guardNotMet: return false
        }
    }
    ...
    var httpStatusCode: UInt {
        ...
        case .disabled, .automationDisabled: return 503
        }
    }
    ...
    private enum CodingKeys: String, CodingKey {
        case status, automationId, automationName, message
    }
    ...
    private var statusString: String {
        ...
        case .automationDisabled: return "automation_disabled"
        }
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        case .scheduled(let id, let name),
             ...
             .automationDisabled(let id, let name):
            try container.encode(id, forKey: .automationId)
            try container.encode(name, forKey: .automationName)
    ...
    init(from decoder: Decoder) throws {
        ...
        switch status {
        case "scheduled":
            let id = try container.decode(UUID.self, forKey: .automationId)
            let name = try container.decode(String.self, forKey: .automationName)
            self = .scheduled(automationId: id, automationName: name)
        case "replaced":
            let id = try container.decode(UUID.self, forKey: .automationId)
            let name = try container.decode(String.self, forKey: .automationName)
            self = .replaced(automationId: id, automationName: name)
        case "queued":
            let id = try container.decode(UUID.self, forKey: .automationId)
            let name = try container.decode(String.self, forKey: .automationName)
            self = .queued(automationId: id, automationName: name)
        case "ignored":
            let id = try container.decode(UUID.self, forKey: .automationId)
            let name = try container.decode(String.self, forKey: .automationName)
            self = .ignored(automationId: id, automationName: name)
        case "cancelled":
            let id = try container.decode(UUID.self, forKey: .automationId)
            let name = try container.decode(String.self, forKey: .automationName)
            self = .cancelled(automationId: id, automationName: name)
        case "not_found":
            self = .notFound
        case "disabled":
            self = .disabled
        case "automation_disabled":
            let id = try container.decode(UUID.self, forKey: .automationId)
            let name = try container.decode(String.self, forKey: .automationName)
            self = .automationDisabled(automationId: id, automationName: name)
        default:
