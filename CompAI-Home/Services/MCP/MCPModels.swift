...
enum MCPConstants {
    ...
    static let serverName = "CompAI-Home"
    static let serverVersion = "1.0.0"
    static let serverInstructions = """
        This MCP server exposes Apple HomeKit smart home devices and automation automations. \
        ...
        For automation, use 'list_automations' to see existing automations, \
        'create_automation' to define new automations with triggers, conditions, \
        and action blocks, 'update_automation' to modify them, 'enable_automation' \
        to toggle them on/off, 'trigger_automation' for manual testing, and \
        'get_automation_logs' to review execution history. Automations can react \
