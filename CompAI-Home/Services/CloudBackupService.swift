...
class CloudBackupService: ObservableObject, CloudBackupServiceProtocol {
    ...
    init(
        ...
        setupAutoBackup(automationStorageService: automationStorageService)
    }
    ...
    func saveToCloud() async throws {
        ...
        do {
            ...
            let tempURL = FileManager.default.temporaryDirectory
                .appendingPathComponent("\(bundle.backupId.uuidString).compaihome")
    ...
    private func setupAutoBackup(automationStorageService: AutomationStorageService) {
