...
struct LogRow: View {
    ...
    private var hasDetailedData: Bool {
        log.detailedRequestBody != nil || log.detailedResponseBody != nil || (log.automationExecution?.blockResults.isEmpty == false) || log.aiInteraction != nil
    }
    ...
    private var categoryColor: Color {
        ...
        case .automationError: return Theme.Status.error
        case .automationExecution: return Theme.Status.active
    ...
    private var contentSection: some View {
        ...
        case .automationExecution(let e):
            automationContent(e, isError: false)
        case .automationError(let e):
            automationContent(e, isError: true)
    ...
    private func automationContent(_ e: AutomationExecutionLog, isError: Bool) -> some View {
    ...
    private var detailSection: some View {
        VStack(alignment: .leading, spacing: 6) {
            VStack(alignment: .leading, spacing: 6) {
                ...
                // Automation execution: show inline block tree
                else if let execLog = log.automationExecution {
                    automationBlockTree(execLog)
                } else {
    ...
    @ViewBuilder
    private func automationBlockTree(_ e: AutomationExecutionLog) -> some View {
        VStack(alignment: .leading, spacing: 2) {
...
#Preview {
    List {
        Section(header: Text("Device State Change")) {
            ...
            NavigationLink {
                Text("Automation Detail View")
            } label: {
                AutomationExecutionLogRow(log: PreviewData.sampleAutomationLogs[0])
            }
            .buttonStyle(.plain)
            .listRowBackground(Theme.contentBackground)
            ...
            NavigationLink {
                ...
                AutomationExecutionLogRow(log: PreviewData.sampleAutomationLogs[1])
            }
            .listRowBackground(Theme.contentBackground)
            ...
            NavigationLink {
                ...
                AutomationExecutionLogRow(log: PreviewData.sampleAutomationLogs[2])
            }
            .listRowBackground(Theme.contentBackground)
        }
    }
