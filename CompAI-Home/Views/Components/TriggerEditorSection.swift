    ...
    var body: some View {
        Section {
            ...
            Menu {
                ...
                Button { triggers.append(.emptyAutomation()) } label: {
                    Label("Automation", systemImage: "arrow.triangle.turn.up.right.diamond")
                }
...
private struct TriggerRow: View {
    ...
    private var triggerContent: some View {
        ...
        Picker("If automation is running?", selection: $trigger.retriggerPolicy) {
    ...
    // MARK: - Automation Trigger Content

    @ViewBuilder
    private var automationTriggerContent: some View {
        Text("This automation can be launched from an Execute Automation block in another automation.")
            .font(.footnote)
            .foregroundColor(Theme.Text.secondary)
    }
